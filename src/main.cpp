...
uint256 hashGenesisBlock("0x00000000a8334ccbb2e52247872c1f0d01fd93f2ae034b1523489ae2cb861a2b");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 1200 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1200);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000a8334ccbb2e52247872c1f0d01fd93f2ae034b1523489ae2cb861a2b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1426591577;
        block.nBits    = 486604799;
        block.nNonce   = 368682844;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WhalecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WhalecoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running WhalecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WhalecoinMiner terminated\n");
        throw;
    }
}
